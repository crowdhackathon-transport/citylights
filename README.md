...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-example-vzachos-mapaplication.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-example-vzachos-mapaplication)

This repository contains the source code for the [City Lights](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.example.vzachos.mapaplication).

Please see the [issues](https://github.com.example.vzachos.mapaplication/com-example-vzachos-mapaplication/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about City Lights? Ask away on the [com-example-vzachos-mapaplication discussion forum](https://groups.google.com/forum/#!forum/com-example-vzachos-mapaplication).

<a href="https://play.google.com/store/apps/details?id=com.example.vzachos.mapaplication" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.example.vzachos.mapaplication__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.example.vzachos.mapaplication__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.example.vzachos.mapaplication.R__) will now be renamed
...
signed with a different key.  Manually uninstall City Lights from your device and
...
City Lights is a result of a template project I've developed over the years as well as
...
City Lights is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.example.vzachos.mapaplication/com-example-vzachos-mapaplication/contributors) on
...
[pull requests](https://github.com.example.vzachos.mapaplication/com-example-vzachos-mapaplication/pulls).
