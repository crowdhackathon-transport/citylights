...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.example.vzachos.mapaplication";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "City Lights";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.example.vzachos.mapaplication.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.example.vzachos.mapaplication.";
