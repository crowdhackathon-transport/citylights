...
public class BootstrapPagerAdapter extends FragmentPagerAdapter {
     ...
     */
    public BootstrapPagerAdapter(final Resources resources, final FragmentManager fragmentManager,MainActivity mainActivity) {
    ...
    public Fragment getItem(final int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                ((UserListFragment)result).setMainActivity(mainActivity);
                break;
            case 2:
