...
package com.example.vzachos.mapaplication.test;

import static com.example.vzachos.mapaplication.core.Constants.Extra.NEWS_ITEM;
import android.content.Intent;
import android.test.ActivityInstrumentationTestCase2;

import com.example.vzachos.mapaplication.core.News;
import com.example.vzachos.mapaplication.ui.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link com.example.vzachos.mapaplication.ui.CarouselActivity}
     */
    public NewsViewTest() {
